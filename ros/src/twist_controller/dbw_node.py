...
class DBWNode(object):
    def __init__(self):
        ...
        rospy.Subsriber('/vehicle/dbw_enabled', Bool, self.dbw_enabled_cb)
        rospy.Subsriber('/twist_cmd', TwistStamped, self.twist_cb)
        rospy.Subsriber('/current_velocity', TwistStamped, self.velocity_cb)
